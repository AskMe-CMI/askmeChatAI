...
export async function middleware(request: NextRequest) {
  ...
  if (pathname === '/login' || pathname === '/login-google' || pathname === '/login-backup' || pathname === '/oidc/callback' || pathname === '/logint' || pathname.startsWith('/register/success') || pathname.startsWith('/register') || pathname.startsWith('/verify-email')) {
  ...
  if (session && (pathname === '/login' || pathname === '/login-backup' || pathname === '/oidc/callback' || pathname === '/logint' || pathname === '/register' || pathname === '/registerCloudDrive' || pathname === '/verify-email')) {
